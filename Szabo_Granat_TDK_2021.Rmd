...
load("C:/school/szem_8/TDK-yieldcurve/yieldcurve/dat2.RData") 
...
dat_plm <- dat_yields %>% 
  ...
  mutate(
    date = lubridate::yq(paste0(str_sub(as.character(date), end = 4), 'Q', ((as.numeric(str_sub(as.character(date), start = 6, end = 7)) -1) %/% 3 + 1)))
  ) %>% 
